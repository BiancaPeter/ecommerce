...
public class WishlistItemService {
    ...
    public Wishlist deleteWishlistItemFromWishlistOfUser(AddAndDeleteToWishlistDTO deleteToWishlistDTO) {
        ...
        WishlistItem wishlistItemToDelete = wishlistItemRepository.findWishlistItemByWishlist_UserAndProduct(foundUser, foundProduct);
